...
grid.arrange(layout_matrix = matrix(data = c(1,1,1,2), ncol = 1),
temps_OU %>%
  ...
  labs(title = "Simulated Ornstein-Uhlenbeck Process for Temperature - Last 10 years", x = NULL, y = "Temperature")
,
temps_OU %>%
  select(Denoised, OU, BAR) %>%
  tail(lookback) %>%
